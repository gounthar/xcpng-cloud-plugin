...
public class XcpngTemplate extends AbstractDescribableImpl<XcpngTemplate> {
    ...
    public static class DescriptorImpl extends Descriptor<XcpngTemplate> {
        ...
        /**
         * How the template-name check opens a session. Production builds a Xen Orchestra client from the
         * connection fields the form is carrying; a test injects a fake through {@link #setPoolProbe}.
        ...
        private FormValidation resolveAgainstPool(
            ...
            try {
                ...
                try {
                    ...
                    // HypervisorException, so there is nothing on it to branch on. Ask the pool again instead. If it
                    // still answers, it answered about the name.
                    try {
                        client.ping();
